...
export default {
  components: {
    ...
    "z-dynamic-attribute-and-set-editor":
      "pages/inner_components/DyanmicAttrAndSetEditor.vue",
    "z-dynamic-attribute-set-attrs-manager":
      "pages/inner_components/DynamicAttributeSetAttrsManager.vue",
    "z-dynamic-attribute-value-map-manager":
      "pages/inner_components/AttributeValueMapManager.vue"
  },
  routes: [
    {
