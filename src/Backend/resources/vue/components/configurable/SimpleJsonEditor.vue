<template>
  <v-container v-if="components['metanode']">
    <component
      :is="getComponentUi(components['ui'])"
      v-bind="getComponentProps(components)"
...
export default {
  ...
  methods: {
    ...
    getComponentUi(ui) {
      return ui.split("::").shift();
    },
    getComponentProps(component) {
      var parts = component["ui"].split("::");
      if (parts.length <= 1) {
        return component;
      }
